...
export const color = {
  ...
  superficie: {
    ...
    header: "rgba(6,9,16,0.80)",     // el header flota sobre el fondo
    barra: "rgba(11,18,32,0.92)",    // la barra de abajo: casi opaca, tiene que
                                     // leerse sobre cualquier contenido
  },

  // Velos: el negro que se pone detrás de un pop-up para apagar el fondo.
  velo: {
    suave: "rgba(0,0,0,0.45)",
    normal: "rgba(0,0,0,0.60)",
    fuerte: "rgba(0,0,0,0.70)",
  },
  ...
  identidad: {
    base: "rgba(99,102,241,0.65)",    // el punto vivo: un logo, un avatar
    medio: "rgba(99,102,241,0.22)",   // los glows del fondo
    tenue: "rgba(99,102,241,0.12)",   // fondos de acento
    borde: "rgba(99,102,241,0.25)",
    texto: "rgba(165,180,252,0.85)",  // índigo claro, legible sobre el fondo
  },
  ...
  estado: {
    ...
    alDiaTenue: "rgba(34,197,94,0.12)",
    alDiaBorde: "rgba(34,197,94,0.25)",
    alDiaTexto: "rgba(134,239,172,0.90)",   // verde claro, legible sobre el fondo
...
export const sombra = {
  // Tres profundidades. Antes había nueve sombras distintas, casi todas
  // variaciones de la misma idea con dos píxeles de diferencia.
  suave: "0 10px 28px rgba(0,0,0,0.30)",
  media: "0 20px 50px rgba(0,0,0,0.35)",
