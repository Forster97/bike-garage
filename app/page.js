...
const s = {
  ...
  navLink: { textDecoration: "none", fontSize: 14, color: "rgba(255,255,255,0.65)", padding: "8px 14px", borderRadius: 10, fontWeight: 500 },
  cta: { textDecoration: "none", fontSize: 14, fontWeight: 700, color: "#060910", background: "rgba(255,255,255,0.93)", padding: "9px 16px", borderRadius: 10, letterSpacing: "-0.2px" },
  ...
  primaryCta: { display: "inline-flex", alignItems: "center", textDecoration: "none", fontWeight: 700, fontSize: 15, padding: "14px 22px", borderRadius: 12, color: "#060910", background: "linear-gradient(135deg, rgba(255,255,255,0.97), rgba(255,255,255,0.85))", boxShadow: "0 0 40px rgba(255,255,255,0.12), 0 8px 24px rgba(0,0,0,0.4)", letterSpacing: "-0.2px" },
  ghostCta: { display: "inline-flex", alignItems: "center", textDecoration: "none", fontWeight: 600, fontSize: 15, padding: "14px 22px", borderRadius: 12, color: "rgba(255,255,255,0.72)", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.10)" },
  statsRow: { display: "flex", flexWrap: "wrap", alignSelf: "flex-start", borderRadius: 14, overflow: "hidden", border: "1px solid rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.04)" },
  statItem: { padding: "14px 20px" },
